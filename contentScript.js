function composeEmail(email, subject, person_name, company_name, checkedornot, jobLink, jobTitle, engineer) {
    return new Promise((resolve)=> {
        ...
        if(checkedornot=="false" || checkedornot==null){
          ...
          <p>I would love to get a referral from your side or forwarding my application to the HR/Recruiting team for the ${jobTitle} role at ${company_name.charAt(0).toUpperCase() + company_name.slice(1)}. I believe that my experience aligns well with the requirements of the role, making it a suitable fit for me.</p>
