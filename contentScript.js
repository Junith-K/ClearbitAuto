function composeEmail(email, subject, person_name, company_name) {
    return new Promise((resolve)=> {
        ...
        //important
        //ceo
        // divElement.innerHTML = `https://docs.google.com/forms/d/e/1FAIpQLScYENcU2ZPmi0E9Guw7xXYYW4TrnZU3R4zw_R2MWdlgDt3D_A/viewform
        ...
        // <p>Additionally, I have one year of practical experience gained through internships where I worked on various web development projects. I'm now looking for an Software/Frontend Engineer opportunity to further expand my skills and contribute effectively to an awesome team like yours.</p>
        
        // <p>If there's an opportunity for a Software/Frontend Engineer at ${company_name.charAt(0).toUpperCase() + company_name.slice(1)}, I'd love to be considered. I believe this experience would be a great fit for both of us.</p>
        ...
        <p>Additionally, I have one year of practical experience gained through internships where I worked on various web development projects. I'm now looking for an Software Engineer Internship opportunity to further expand my skills and contribute effectively to an awesome team like yours.</p>
        
        <p>I would love to get a referral from your side for the Software Engineer Intern role at ${company_name.charAt(0).toUpperCase() + company_name.slice(1)}. I believe this experience would be a great fit for me.</p>
        ...
        <a href="https://wellfound.com/l/2zpLXL">Job_Link</a>
...
let namui="";
let subject = "Expressing Interest in Software Engineer Intern Opportunity";
...
async function checkForElement6(format, gmail, domain) {
  const targetElements = document.querySelectorAll(".cb-mb-0.cb-mt-0.cb-text-lg.cb-font-medium");
...
chrome.runtime.onMessage.addListener(function (message, sender, sendResponse) {
    ...
    if (message.messageText === "f1") {
      ...
      checkInterval5 = setInterval(() => checkForElement6(message.messageText,message.email,message.domain), 1000);
    }
});